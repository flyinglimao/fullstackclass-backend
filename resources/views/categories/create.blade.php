                            ...
                            <div class="card-body">
                                ...
                                <!-- 錯誤訊息 -->
                                    ...
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">分類名稱</label>
                                        <input class="form-control" type="text" placeholder="請輸入分類名稱" id="example-text-input" name="name" value="{{old('name')}}">
                                    </div>
