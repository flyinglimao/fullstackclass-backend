                                ...
                                <table class="dbkit-table">
                                    ...
                                    @foreach($members_list as $member)
                                        <tr>
                                            ...
                                            <td class="coin-name">{{$member->realname}} </td>
                                            <td class="attachments">{{$member->username}} </td>
                                            <td class="coin-name">{{$member->level}} </td>
                                            <td class="attachments">{{$member->email}}</td>
                                            <td class="attachments">{{$member->phone}} <img src="{{asset('images/icon/market-value/triangle-down.png')}}" alt="icon"></td>
                                            <td class="attachments">
