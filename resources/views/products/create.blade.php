                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('products.store')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="請輸入title" id="example-text-input" name="title">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-search-input" class="col-form-label">subtitle</label>
                                        <input class="form-control" type="text" placeholder="請輸入subtitle" id="example-search-input" name="subtitle">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-textarea-input" class="col-form-label">description</label>
                                        <textarea  class="form-control" cols="20" rows="4" placeholder="請輸入description" id="example-textarea-input" name="description"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">type</label>
                                        <input class="form-control" type="text" placeholder="請輸入type" id="example-url-input" name="type">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-tel-input" class="col-form-label">author</label>
                                        <input class="form-control" type="tel" placeholder="請輸入author" id="example-tel-input" name="author">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword" class="">publisher</label>
                                        <input class="form-control" type="text" placeholder="請輸入publisher" id="inputPassword"  name="publisher">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-number-input" class="col-form-label">isbn</label>
                                        <input class="form-control" type="text" placeholder="請輸入isbn" id="example-number-input" name="isbn">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-category-input" class="col-form-label">category</label>
                                        <input class="form-control" type="text" placeholder="請輸入category" id="example-category-input" name="category">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-list_price-input" class="col-form-label">list_price</label>
                                        <input class="form-control" type="text" placeholder="請輸入list_price" id="example-list_price-input" name="list_price">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-sale_price-input" class="col-form-label">sale_price</label>
                                        <input class="form-control" type="text" placeholder="請輸入sale_price" id="example-sale_price-input" name="sale_price">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-stock-input" class="col-form-label">stock</label>
                                        <input class="form-control" type="text" placeholder="請輸入stock" id="example-stock-input" name="stock">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" type="submit" value="提交">
                                    </div>
