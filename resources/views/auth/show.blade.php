                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input disabled class="form-control" type="text" value="{{$user->name}}" id="example-text-input" name="name">
                        </div>
                        <div class="form-group">
                            <label for="example-email-input" class="col-form-label">電子郵件</label>
                            <input disabled class="form-control" type="text" value="{{$user->email}}" id="example-email-input" name="email">
                        </div>
                        <div class="form-group">
                            <label for="example-admin-input" class="col-form-label">權限</label>
                            <input disabled class="form-control" type="text" value="{{(int)$user->isAdmin?'管理員':'會員'}}" id="example-admin-input">
                        </div>
                        <div class="form-group">
                            <label for="example-bonus-input" class="col-form-label">紅利點數</label>
                            <input disabled class="form-control" type="text" value="{{(int)$user->bonus}}" id="example-bonus-input">
                        </div>
                        <div class="form-group">
